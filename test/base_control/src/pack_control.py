...
class PackControl():
  ...
  def parse_imu(self,base_frame:BaseFrame):
    ...
    # 发布TF变换
    self.send_transform(self.base_control.get_clock().now().to_msg(),translation=(float(self.odom_pose_[0]),float(self.odom_pose_[1]),0.05),rotation=quat,parent="odom",child="imu")
