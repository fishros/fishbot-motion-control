...
void oled_init()
{
    ...
    uint8_t text[][16]={
        {0xBF,0xBF,0xBD,0xBD,0xBD,0xBD,0xBD,0x01,0xBD,0xBD,0xBD,0xBD,0xBD,0xBF,0xBF,0xFF},
        {0x7F,0x7F,0xBF,0xDF,0xEF,0xF3,0xFC,0xFF,0xFC,0xF3,0xEF,0xDF,0xBF,0x7F,0x7F,0xFF},/*"天",4*/
        {0xFF,0xFB,0xFB,0xFB,0xFB,0xFB,0xFB,0x03,0xFB,0xFB,0xFB,0xFB,0xFB,0xFB,0xFF,0xFF},
        {0xDF,0xDF,0xDF,0xDF,0xDF,0xDF,0xDF,0xC0,0xDF,0xDF,0xDF,0xDF,0xDF,0xDF,0xDF,0xFF},/*"工",5*/
        {0x7F,0x7D,0x7D,0x7D,0x01,0x7D,0x7D,0x7D,0x7D,0x7D,0x01,0x7D,0x7D,0x7D,0x7F,0xFF},
        {0xFF,0x7F,0xBF,0xCF,0xF0,0xFF,0xFF,0xFF,0xFF,0xFF,0x00,0xFF,0xFF,0xFF,0xFF,0xFF},/*"开",6*/
        {0xBF,0xC3,0xEF,0x00,0xEF,0xEF,0xDF,0xEF,0x70,0x87,0xF7,0x07,0xF7,0x07,0xFF,0xFF},
        {0xFD,0xF9,0xFD,0x00,0xFE,0xFE,0xFB,0xBD,0xDE,0xE7,0xB9,0x7E,0xBF,0xC0,0xFF,0xFF}/*"物",7*/
    };
    i2c_master_init();
    ...
    oled_ascii(0,0,"  TianGongV1.0  ");
    // oled_setxy(32,0);
    // for(i=0;i<8;i+=2){
    //     for(y=0;y<16;y++)
    //         oled_write(0x40,text[i][y]);
    // }
    // oled_setxy(32,1);
    // for(i=1;i<8;i+=2){
    // for(y=0;y<16;y++)
